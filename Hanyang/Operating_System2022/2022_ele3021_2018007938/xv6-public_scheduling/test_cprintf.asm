...
int main(int argc, char *argv[])
{
  ...
  18:	e8 06 03 00 00       	call   323 <getpid>
  1d:	89 c3                	mov    %eax,%ebx
  1f:	e8 17 03 00 00       	call   33b <uptime>
  24:	53                   	push   %ebx
  25:	50                   	push   %eax
  26:	68 a8 07 00 00       	push   $0x7a8
  2b:	6a 01                	push   $0x1
  2d:	e8 0e 04 00 00       	call   440 <printf>
  32:	83 c4 10             	add    $0x10,%esp
  35:	eb e1                	jmp    18 <main+0x18>
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb c0 07 00 00       	mov    $0x7c0,%ebx
        while(*s != 0){
