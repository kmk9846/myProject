  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  18:	68 95 08 00 00       	push   $0x895
  1d:	6a 01                	push   $0x1
  1f:	e8 dc 04 00 00       	call   500 <printf>
  24:	83 c4 10             	add    $0x10,%esp
    thread_create(&thread[i], thread_main, (void *)i);
  27:	83 ec 04             	sub    $0x4,%esp
  2a:	8d 04 9d b0 0b 00 00 	lea    0xbb0(,%ebx,4),%eax
  31:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
  ...
  3a:	50                   	push   %eax
  3b:	e8 eb 03 00 00       	call   42b <thread_create>
  for (i = 0; i < NUM_THREAD; i++) {
  ...
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 b0 08 00 00       	push   $0x8b0
  5c:	6a 01                	push   $0x1
  5e:	e8 9d 04 00 00       	call   500 <printf>
  exit();
...
00000070 <thread_main>:
{
  ...
  c0:	58                   	pop    %eax
  c1:	5a                   	pop    %edx
  c2:	68 87 08 00 00       	push   $0x887
  c7:	6a 01                	push   $0x1
    char *args[2] = {pname, 0};
  c9:	c7 45 f0 79 08 00 00 	movl   $0x879,-0x10(%ebp)
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb d3 08 00 00       	mov    $0x8d3,%ebx
        while(*s != 0){
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 a4 0b 00 00       	mov    %eax,0xba4
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 a4 0b 00 00       	mov    %eax,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 a4 0b 00 00       	mov    0xba4,%eax
