...
int main(int argc, char *argv[])
{
  ...
  15:	e8 19 03 00 00       	call   333 <getpid>
  1a:	83 ec 04             	sub    $0x4,%esp
  1d:	50                   	push   %eax
  1e:	68 b8 07 00 00       	push   $0x7b8
  23:	6a 01                	push   $0x1
  25:	e8 26 04 00 00       	call   450 <printf>
    int ppid = getppid();
  2a:	e8 2c 03 00 00       	call   35b <getppid>
    printf(1, "My ppid is %d\n", ppid);
  2f:	83 c4 0c             	add    $0xc,%esp
  32:	50                   	push   %eax
  33:	68 c6 07 00 00       	push   $0x7c6
  38:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb d5 07 00 00       	mov    $0x7d5,%ebx
        while(*s != 0){
