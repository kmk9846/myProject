...
int main(int argc, char *argv[])
{
  ...
  1f:	7e 20                	jle    41 <main+0x41>
        {
            printf(1, "Parent\n");
  21:	83 ec 08             	sub    $0x8,%esp
  24:	68 c8 07 00 00       	push   $0x7c8
  29:	6a 01                	push   $0x1
  2b:	e8 30 04 00 00       	call   460 <printf>
            yield();
  30:	e8 3e 03 00 00       	call   373 <yield>
  35:	83 c4 10             	add    $0x10,%esp
        int n_fork = fork();
  38:	e8 7e 02 00 00       	call   2bb <fork>
        if (n_fork > 0) 
  3d:	85 c0                	test   %eax,%eax
  3f:	7f e0                	jg     21 <main+0x21>
        }
        else if(n_fork == 0) 
  41:	75 d5                	jne    18 <main+0x18>
        {
            printf(1, "Child\n");
  43:	83 ec 08             	sub    $0x8,%esp
  46:	68 d0 07 00 00       	push   $0x7d0
  4b:	6a 01                	push   $0x1
  4d:	e8 0e 04 00 00       	call   460 <printf>
            yield();
  52:	e8 1c 03 00 00       	call   373 <yield>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	eb bc                	jmp    18 <main+0x18>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb d7 07 00 00       	mov    $0x7d7,%ebx
        while(*s != 0){
