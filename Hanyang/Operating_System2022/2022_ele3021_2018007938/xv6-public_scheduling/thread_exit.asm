  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  3a:	50                   	push   %eax
  3b:	e8 bb 03 00 00       	call   3fb <thread_create>
  for (i = 0; i < NUM_THREAD; i++) {
  ...
  50:	e8 6e 03 00 00       	call   3c3 <sleep>
  printf(1, "This code shouldn't be executed!!\n");
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 70 08 00 00       	push   $0x870
  5c:	6a 01                	push   $0x1
  5e:	e8 6d 04 00 00       	call   4d0 <printf>
  exit();
  63:	e8 cb 02 00 00       	call   333 <exit>
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
00000070 <thread_main>:
{
  ...
  90:	74 20                	je     b2 <thread_main+0x42>
    sleep(200);
  92:	83 ec 0c             	sub    $0xc,%esp
  95:	68 c8 00 00 00       	push   $0xc8
  9a:	e8 24 03 00 00       	call   3c3 <sleep>
  printf(1, "This code shouldn't be executed!!\n");
  9f:	58                   	pop    %eax
  a0:	5a                   	pop    %edx
  a1:	68 70 08 00 00       	push   $0x870
  a6:	6a 01                	push   $0x1
  ...
  b5:	6a 64                	push   $0x64
  b7:	e8 07 03 00 00       	call   3c3 <sleep>
    printf(1, "Exiting...\n");
  bc:	59                   	pop    %ecx
  bd:	5b                   	pop    %ebx
  be:	68 49 08 00 00       	push   $0x849
  c3:	6a 01                	push   $0x1
  c5:	e8 06 04 00 00       	call   4d0 <printf>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 93 08 00 00       	mov    $0x893,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 64 0b 00 00       	mov    0xb64,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 64 0b 00 00 68 	movl   $0xb68,0xb64
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 68 0b 00 00       	mov    $0xb68,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 822:	00 00 00 
    if(p->s.size >= nunits){
