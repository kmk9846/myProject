...
_userdelete_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  11:	53                   	push   %ebx
  12:	51                   	push   %ecx
  13:	83 ec 48             	sub    $0x48,%esp
  char username[50];
  printf(1, "[Delete user]\n");
  16:	68 d8 07 00 00       	push   $0x7d8
  1b:	6a 01                	push   $0x1
  ...
  22:	59                   	pop    %ecx
  23:	5b                   	pop    %ebx
  24:	68 e7 07 00 00       	push   $0x7e7
  29:	6a 01                	push   $0x1
  gets(username, sizeof username);
  2b:	8d 5d c6             	lea    -0x3a(%ebp),%ebx
  printf(1, "Username: ");
  2e:	e8 3d 04 00 00       	call   470 <printf>
  gets(username, sizeof username);
  33:	58                   	pop    %eax
  34:	5a                   	pop    %edx
  35:	6a 32                	push   $0x32
  37:	53                   	push   %ebx
  38:	e8 73 01 00 00       	call   1b0 <gets>
  username[strlen(username) - 1] = 0;
  3d:	89 1c 24             	mov    %ebx,(%esp)
  40:	e8 cb 00 00 00       	call   110 <strlen>
  
  if (deleteUser(username) == 0)
  45:	89 1c 24             	mov    %ebx,(%esp)
  username[strlen(username) - 1] = 0;
  48:	c6 44 05 c5 00       	movb   $0x0,-0x3b(%ebp,%eax,1)
  if (deleteUser(username) == 0)
  4d:	e8 51 03 00 00       	call   3a3 <deleteUser>
  52:	83 c4 10             	add    $0x10,%esp
  55:	85 c0                	test   %eax,%eax
  57:	75 16                	jne    6f <main+0x6f>
    printf(1, "Delete user successful!\n");
  59:	52                   	push   %edx
  5a:	52                   	push   %edx
  5b:	68 f2 07 00 00       	push   $0x7f2
  60:	6a 01                	push   $0x1
  62:	e8 09 04 00 00       	call   470 <printf>
  67:	83 c4 10             	add    $0x10,%esp
  else
    printf(1, "Delete user failed!\n");
  exit();
  6a:	e8 84 02 00 00       	call   2f3 <exit>
    printf(1, "Delete user failed!\n");
  6f:	50                   	push   %eax
  70:	50                   	push   %eax
  71:	68 0b 08 00 00       	push   $0x80b
  76:	6a 01                	push   $0x1
  78:	e8 f3 03 00 00       	call   470 <printf>
  7d:	83 c4 10             	add    $0x10,%esp
  80:	eb e8                	jmp    6a <main+0x6a>
  82:	66 90                	xchg   %ax,%ax
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 20 08 00 00       	mov    $0x820,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 d4 0a 00 00       	mov    0xad4,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 ...
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf d8 0a 00 00       	mov    $0xad8,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 7c2:	00 00 00 
    if(p->s.size >= nunits){
