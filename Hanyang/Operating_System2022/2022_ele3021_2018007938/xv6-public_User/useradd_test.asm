...
_useradd_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  12:	53                   	push   %ebx
  13:	51                   	push   %ecx
  14:	81 ec 84 00 00 00    	sub    $0x84,%esp
  char username[50], password[50];
  printf(1, "[Add user]\n");
  1a:	68 f8 07 00 00       	push   $0x7f8
  1f:	6a 01                	push   $0x1
  ...
  26:	59                   	pop    %ecx
  27:	5b                   	pop    %ebx
  28:	68 04 08 00 00       	push   $0x804
  2d:	6a 01                	push   $0x1
  gets(username, sizeof username);
  2f:	8d 5d 84             	lea    -0x7c(%ebp),%ebx
  printf(1, "Username: ");
  ...
  39:	6a 32                	push   $0x32
  3b:	53                   	push   %ebx
  3c:	e8 8f 01 00 00       	call   1d0 <gets>
  username[strlen(username) - 1] = 0;
  41:	89 1c 24             	mov    %ebx,(%esp)
  44:	e8 e7 00 00 00       	call   130 <strlen>
  49:	c6 44 05 83 00       	movb   $0x0,-0x7d(%ebp,%eax,1)
  ...
  5c:	59                   	pop    %ecx
  5d:	5e                   	pop    %esi
  5e:	8d 75 b6             	lea    -0x4a(%ebp),%esi
  61:	6a 32                	push   $0x32
  63:	56                   	push   %esi
  64:	e8 67 01 00 00       	call   1d0 <gets>
  password[strlen(password) - 1] = 0;
  69:	89 34 24             	mov    %esi,(%esp)
  6c:	e8 bf 00 00 00       	call   130 <strlen>
  71:	c6 44 05 b5 00       	movb   $0x0,-0x4b(%ebp,%eax,1)
  ...
  78:	56                   	push   %esi
  79:	53                   	push   %ebx
  7a:	e8 3c 03 00 00       	call   3bb <addUser>
  7f:	83 c4 10             	add    $0x10,%esp
  82:	85 c0                	test   %eax,%eax
  84:	75 16                	jne    9c <main+0x9c>
    printf(1, "Add user successful!\n");
  86:	52                   	push   %edx
  87:	52                   	push   %edx
  88:	68 1a 08 00 00       	push   $0x81a
  8d:	6a 01                	push   $0x1
  ...
  exit();
  97:	e8 77 02 00 00       	call   313 <exit>
    printf(1, "Add user failed!\n");
  9c:	50                   	push   %eax
  9d:	50                   	push   %eax
  9e:	68 30 08 00 00       	push   $0x830
  a3:	6a 01                	push   $0x1
  a5:	e8 e6 03 00 00       	call   490 <printf>
  aa:	83 c4 10             	add    $0x10,%esp
  ad:	eb e8                	jmp    97 <main+0x97>
  af:	90                   	nop
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 4c 08 00 00 	movzbl 0x84c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 42 08 00 00       	mov    $0x842,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 fc 0a 00 00       	mov    %eax,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 fc 0a 00 00       	mov    0xafc,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 ...
 7be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 7e2:	00 00 00 
    if(p->s.size >= nunits){
