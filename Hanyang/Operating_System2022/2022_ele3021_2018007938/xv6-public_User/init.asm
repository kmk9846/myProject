...
main(void)
{
  ...
  openfile("userlist");
  43:	c7 04 24 40 08 00 00 	movl   $0x840,(%esp)
  4a:	e8 a4 03 00 00       	call   3f3 <openfile>
  printf(1, "init: starting login\n");
  4f:	58                   	pop    %eax
  50:	5a                   	pop    %edx
  51:	68 49 08 00 00       	push   $0x849
  56:	6a 01                	push   $0x1
  ...
  for(;;){
	...
	pid = fork();
  60:	e8 e6 02 00 00       	call   34b <fork>
  ...
  77:	78 e7                	js     60 <main+0x60>
  79:	39 c3                	cmp    %eax,%ebx
  7b:	74 e3                	je     60 <main+0x60>
		printf(1,"zombie!\n");
  ...
  ab:	68 78 08 00 00       	push   $0x878
  b0:	e8 d6 02 00 00       	call   38b <exec>
		printf(1, "init: exec login failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 7e 08 00 00       	push   $0x87e
  bc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb a0 08 00 00       	mov    $0x8a0,%ebx
        while(*s != 0){
