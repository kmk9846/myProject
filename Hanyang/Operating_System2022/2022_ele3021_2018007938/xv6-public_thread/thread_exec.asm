...
_thread_exec:     file format elf32-i386
  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  18:	68 65 08 00 00       	push   $0x865
  1d:	6a 01                	push   $0x1
  1f:	e8 ac 04 00 00       	call   4d0 <printf>
  24:	83 c4 10             	add    $0x10,%esp
    thread_create(&thread[i], thread_main, (void *)i);
  27:	83 ec 04             	sub    $0x4,%esp
  2a:	8d 04 9d 80 0b 00 00 	lea    0xb80(,%ebx,4),%eax
  31:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
  32:	83 c3 01             	add    $0x1,%ebx
    thread_create(&thread[i], thread_main, (void *)i);
  35:	68 70 00 00 00       	push   $0x70
  3a:	50                   	push   %eax
  3b:	e8 c3 03 00 00       	call   403 <thread_create>
  for (i = 0; i < NUM_THREAD; i++) {
  40:	83 c4 10             	add    $0x10,%esp
  43:	83 fb 05             	cmp    $0x5,%ebx
  46:	75 df                	jne    27 <main+0x27>
  }
  sleep(200);
  48:	83 ec 0c             	sub    $0xc,%esp
  4b:	68 c8 00 00 00       	push   $0xc8
  50:	e8 9e 03 00 00       	call   3f3 <sleep>
  printf(1, "This code shouldn't be executed!!\n");
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 80 08 00 00       	push   $0x880
  5c:	6a 01                	push   $0x1
  5e:	e8 6d 04 00 00       	call   4d0 <printf>
  exit();
  63:	e8 fb 02 00 00       	call   363 <exit>
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
00000070 <thread_main>:
{
  ...
  77:	53                   	push   %ebx
  78:	83 ec 18             	sub    $0x18,%esp
  7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "Thread %d start\n", val);
  7e:	53                   	push   %ebx
  7f:	68 38 08 00 00       	push   $0x838
  84:	6a 01                	push   $0x1
  86:	e8 45 04 00 00       	call   4d0 <printf>
  if (arg == 0) {
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	85 db                	test   %ebx,%ebx
  90:	74 24                	je     b6 <thread_main+0x46>
    sleep(200);
  92:	83 ec 0c             	sub    $0xc,%esp
  95:	68 c8 00 00 00       	push   $0xc8
  9a:	e8 54 03 00 00       	call   3f3 <sleep>
  9f:	83 c4 10             	add    $0x10,%esp
  printf(1, "This code shouldn't be executed!!\n");
  a2:	83 ec 08             	sub    $0x8,%esp
  a5:	68 80 08 00 00       	push   $0x880
  aa:	6a 01                	push   $0x1
  ac:	e8 1f 04 00 00       	call   4d0 <printf>
  exit();
  b1:	e8 ad 02 00 00       	call   363 <exit>
    sleep(100);
  b6:	83 ec 0c             	sub    $0xc,%esp
  b9:	6a 64                	push   $0x64
  bb:	e8 33 03 00 00       	call   3f3 <sleep>
    printf(1, "Executing...\n");
  c0:	58                   	pop    %eax
  c1:	5a                   	pop    %edx
  c2:	68 57 08 00 00       	push   $0x857
  c7:	6a 01                	push   $0x1
    char *args[2] = {pname, 0};
  c9:	c7 45 f0 49 08 00 00 	movl   $0x849,-0x10(%ebp)
  d0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    printf(1, "Executing...\n");
  d7:	e8 f4 03 00 00       	call   4d0 <printf>
    exec(pname, args);
  dc:	8d 45 f0             	lea    -0x10(%ebp),%eax
  df:	59                   	pop    %ecx
  e0:	5b                   	pop    %ebx
  e1:	50                   	push   %eax
  e2:	68 49 08 00 00       	push   $0x849
  e7:	e8 af 02 00 00       	call   39b <exec>
  ec:	83 c4 10             	add    $0x10,%esp
  ef:	eb b1                	jmp    a2 <thread_main+0x32>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb a3 08 00 00       	mov    $0x8a3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 74 0b 00 00       	mov    %eax,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 74 0b 00 00       	mov    0xb74,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 74 0b 00 00       	mov    %eax,0xb74
}
